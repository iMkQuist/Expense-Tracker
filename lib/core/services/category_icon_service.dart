...
class CategoryIconService {
  ...
  final expenseList = {
    ...
    Category(3, "Home", FontAwesomeIcons.house, Colors.brown),
    Category(4, "Entertainment", FontAwesomeIcons.gamepad, Colors.cyanAccent),
    Category(5, "Shopping", FontAwesomeIcons.bagShopping, Colors.deepOrange),
    Category(6, "Clothing", FontAwesomeIcons.shirt, Colors.deepOrangeAccent),
    ...
    Category(10, "Sport", FontAwesomeIcons.football, Colors.limeAccent),
